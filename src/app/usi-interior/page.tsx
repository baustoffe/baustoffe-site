...
const sampleProducts = [
  { id: "20", code: "BB-INT-001", name: "Euro Classic", color: "Alb", hex: "#f5f5f0", sizes: "80x200 – 90x210", price: 1250, image: "" },
  { id: "21", code: "BB-INT-002", name: "Kira Slim", color: "Nuc", hex: "#5c4033", sizes: "70x190 – 80x200", price: 1490, image: "" },
  { id: "22", code: "BB-INT-003", name: "Studio M", color: "Stejar Auriu", hex: "#b8860b", sizes: "80x200 – 90x210", price: 1350, image: "" },
  { id: "23", code: "BB-INT-004", name: "Pragma", color: "Antracit", hex: "#36454f", sizes: "90x210 – 100x220", price: 1690, image: "" },
];
    ...
    <div className="pt-24">
      <div className="mx-auto max-w-7xl px-6 pb-8">
        <nav className="text-[11px] text-[#141414]/40 mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          <Link href="/" className="hover:text-[#141414]">Acasă</Link><span className="mx-2">/</span><span>Uși Interior</span>
        </nav>
        <h1 className="text-4xl md:text-5xl font-bold text-[#141414]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Uși Interior</h1>
        <p className="text-sm text-[#141414]/50 mt-2 font-light" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Uși de interior moderne și clasice, la prețuri competitive.</p>
      </div>
      <div className="mx-auto max-w-7xl px-6 pb-8">
